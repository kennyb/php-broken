...
#define ZEND_DECLARE_INHERITED_CLASS 120
#define ZEND_DECLARE_FUNCTION        121
#define ZEND_USER_OPCODE             122
#define ZEND_VERIFY_ABSTRACT_CLASS   123
#define ZEND_HANDLE_EXCEPTION        124
